...
/**
 * AbstractCollection provides default implementations for some of the easy
...
public abstract class WeissAbstractCollection<T> implements WeissCollection<T> {
    ...
    /**
     * Adds x to this collections. This default implementation always throws an
     * exception.
     * 
    ...
    /**
     * Removes non-null x from this collection. (This behavior may not always be
     * appropriate.)
     * 
    ...
    /**
     * Return true if items in other collection are equal to items in this
     * collection (same order, and same according to equals).
     * 
    ...
    /**
     * Return true if two objects are equal; works if objects can be null.
     * 
