...
class SimGUI {
    ...
    /**
     * The probability that two nodes are connected with an edge (used for graph
     * generation).
     */
    private final double prob;

    /**
     * The number of nodes the user requested the graphs have when they are
     * generated.
     */
    ...
    public void makeGraphPanel() {
        ...
        context.setEdgeLabelTransformer(new Transformer<GraphEdge, String>() {
        ...
        context.setArrowFillPaintTransformer(new Transformer<GraphEdge, Paint>() {
        ...
        context.setEdgeDrawPaintTransformer(new Transformer<GraphEdge, Paint>() {
            public Paint transform(GraphEdge e) {
                return e.getColor();
            }
        });
        ...
        context.setEdgeStrokeTransformer(new Transformer<GraphEdge, Stroke>() {
        ...
        // make nodes bigger
        context.setVertexShapeTransformer(new Transformer<GraphNode, Shape>() {
        ...
        context.setVertexLabelTransformer(new Transformer<GraphNode, String>() {
        ...
        context.setVertexFillPaintTransformer(new Transformer<GraphNode, Paint>() {
    ...
    /**
     * Generates a new graph, resetting all the appropriate static variables for
     * nodes and edges.
     */
    public void genGraph() {
        ...
        if (alg.graphEdgeType() == EdgeType.DIRECTED) {
             ...
             * //replace "ThreeTenGraph" below with your undirected graph class below //and
             * uncomment.
             * 
             * ErdosRenyiGeneratorDirected<GraphNode, GraphEdge> gen = new
             * ErdosRenyiGeneratorDirected<>(
             * ThreeTenGraph.<GraphNode,GraphEdge>getFactory(), nodeFactory, edgeFactory,
             * this.numNodes,this.prob ); gen.setSeed(this.rand.nextInt()); graph =
             * gen.create();
             */
        } else {
            ErdosRenyiGenerator<GraphNode, GraphEdge> gen = new ErdosRenyiGenerator<>(
                    ThreeTenGraph.<GraphNode, GraphEdge>getFactory(), nodeFactory, edgeFactory, this.numNodes,
                    this.prob);
